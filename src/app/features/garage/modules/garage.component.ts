...
export class GarageComponent {
  ...
  addVehicle(): void {
    ...
    // Set customerID in vehicleData
    const completeVehicleData = {
      ...vehicleData,
      customerID: this.userID ? parseInt(this.userID, 10) : 0,
    };
    this.vehicleSearchService.setVehicleData(completeVehicleData);
  
    // Log the request payload to the console
    console.log('Sending vehicle data to server:', completeVehicleData);
