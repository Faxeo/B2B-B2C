...
@Component({
    selector: 'app-b2c-search-by-category',
    imports: [FormsModule],
    templateUrl: './b2c-search-by-category.component.html',
    styleUrl: './b2c-search-by-category.component.css'
})

export class B2cSearchByCategoryComponent {
