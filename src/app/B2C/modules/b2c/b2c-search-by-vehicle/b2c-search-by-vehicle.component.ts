...
@Component({
  selector: 'app-b2c-search-by-vehicle',
  standalone: true,
  imports: [CommonModule,FormsModule],
  templateUrl: './b2c-search-by-vehicle.component.html',
  styleUrl: './b2c-search-by-vehicle.component.css'
})
export class B2cSearchByVehicleComponent {
